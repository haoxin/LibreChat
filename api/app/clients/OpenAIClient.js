...
class OpenAIClient extends BaseClient {
  ...
  setOptions(options) {
    ...
    const dataSources = [
      {
        ...
        parameters: {
          ...
          endpoint: 'https://swedencentral.cognitiveservices.azure.com/',
          key: '',
        },
      },
    ];
    ...
    if (this.options.cvEnhancement && this.azureEndpoint?.includes('gpt-4-vision-preview')) {
      this.azureEndpoint = this.azureEndpoint.replace(
        'gpt-4-vision-preview',
        'gpt-4-vision-preview/extensions',
      );
      this.modelOptions = {
        ...this.modelOptions,
        ...modelOptions,
